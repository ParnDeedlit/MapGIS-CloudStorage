            ...
            <Header class="header">
                <Menu mode="horizontal" active-name="1" theme="light"
                    ...
                    <div class="layout-nav">
                        ...
                        <MenuItem name="3" :to="{name:'localCommon'}" style="-webkit-app-region: no-drag;">本地资源</MenuItem>
                        <MenuItem name="4" :to="{name:'shareSession'}" style="-webkit-app-region: no-drag;">好友分享</MenuItem>
                        <MenuItem name="5" :to="{name:'functionList'}" style="-webkit-app-region: no-drag;">功能宝箱</MenuItem>
                        <MenuItem name="6" :to="{name:'otherFilm'}" style="-webkit-app-region: no-drag;">更多资源</MenuItem>
                    </div>
                    <div class="right">
